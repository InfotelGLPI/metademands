...
/**
 * PluginMetademandsBasketobjecttypeTranslation Class
 *
 **/
class PluginMetademandsBasketobjecttypeTranslation extends DropdownTranslation {
...
//    }
    ...
    static function canBeTranslated(CommonGLPI $item) {
        ...
        return ($item instanceof PluginMetademandsBasketobjecttype);
    }
