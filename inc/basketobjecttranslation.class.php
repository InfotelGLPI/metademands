...
/**
 * PluginMetademandsBasketobjectTranslation Class
 *
 **/
class PluginMetademandsBasketobjectTranslation extends DropdownTranslation {
            ...
            foreach ($iterator as $data) {
                ...
                if (empty($searchOption)) {
                    if (isset($item->fields["custom_values"]) && !empty($item->fields["custom_values"])) {
                        $custom = PluginMetademandsBasketobject::_unserialize($item->fields["custom_values"]);
...
//                $params);
        ...
        echo "<td>";
        Dropdown::showFromArray('field', self::getEnumField(),
            [
...
//    }
    ...
    static function canBeTranslated(CommonGLPI $item) {
        ...
        return ($item instanceof PluginMetademandsBasketobject);
    }
