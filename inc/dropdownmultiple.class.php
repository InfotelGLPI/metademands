...
//                            echo '</div>';
                        ...
                        PluginMetademandsFieldParameter::initCustomValue(max(array_keys($custom_values)), false, $display_default);
                        echo "</td>";
                        echo "</tr>";
                    } else {
                        $key = 1;
                        ...
                        PluginMetademandsFieldParameter::initCustomValue(1, false, true);
                        echo "</td>";
                        echo "</tr>";
                    }
                }
