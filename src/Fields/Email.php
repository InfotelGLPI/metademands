 ...
 *
 **/
class Email extends CommonDBTM
{
    /**
    ...
    public static function fieldsMandatoryScript($data)
    {
        ...
        if ($debug) {
            $onchange = "console.log('fieldsMandatoryScript-email $id')";
        }
    ...
    public static function taskScript($data)
    {
        ...
        && $_SESSION['glpi_use_mode'] == Session::DEBUG_MODE ? true : false);
        if ($debug) {
            $script = "console.log('taskScript-email $id');";
        }
...
//                                 }
    ...
    public static function fieldsHiddenScript($data)
    {
        ...
        && $_SESSION['glpi_use_mode'] == Session::DEBUG_MODE ? true : false);
        if ($debug) {
            $onchange = "console.log('fieldsHiddenScript-email $id');";
        }
    ...
    public static function blocksHiddenScript($data)
    {
        ...
        && $_SESSION['glpi_use_mode'] == Session::DEBUG_MODE ? true : false);
        if ($debug) {
            $script = "console.log('blocksHiddenScript-email $id');";
        }
        if (count($check_values) > 0) {
            $script .= "$('[name^=\"field[" . $data["id"] . "]\"]').change(function() {";
