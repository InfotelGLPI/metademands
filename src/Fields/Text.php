...
class Text extends CommonDBTM
{
    ...
    public static function showFieldParameters($params): string
    {
        ...
        $regex_html = Html::input('regex', ['value' => $params["regex"], 'size' => 50]);

        return TemplateRenderer::getInstance()->render(
            '@metademands/fields/field_parameter_text.html.twig',
            [
    ...
    public static function fieldsMandatoryScript($data)
    {
        ...
        if ($debug) {
            $onchange = "console.log('fieldsMandatoryScript-text $id');";
        }
