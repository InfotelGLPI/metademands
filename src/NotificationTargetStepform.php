 ...
 *
 */
class NotificationTargetStepform extends NotificationTarget
{
    public const TARGET_NEXT_GROUP = 6300;
    public const TARGET_NEXT_USER = 6301;
    public const REQUESTER = 6302;
    /**
    ...
    public function getDataForObject(CommonDBTM $item, array $options, $simple = false)
    {
        ...
        $objettypeMeta = strtolower(Metademand::getType());
        $objettype = strtolower($this->obj->getType());
