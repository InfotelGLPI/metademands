...
use DbUtils;
use Html;
use PluginResourcesConfig;
use PluginResourcesContractType;
use PluginResourcesResource;
use PluginResourcesService;
use Session;
use CommonGLPI;
use Toolbox;
use UserCategory;
...
class Metademand_Resource extends CommonDBTM {
   ...
   function getTabNameForItem(CommonGLPI $item, $withtemplate = 0) {
      ...
      if (!$withtemplate) {
         if ($item->getType() == PluginResourcesContractType::class) {
   ...
   static function getTableResource($options) {
