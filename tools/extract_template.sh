...
xgettext *.php */*.php */*.php --copyright-holder='Metademands Development Team' --package-name='GLPI - Metademands plugin' --package-version='2.0.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
