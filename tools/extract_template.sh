...
xgettext *.php */*.php */typefields/*.php --copyright-holder='Metademands Development Team' --package-name='GLPI - Metademands plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
